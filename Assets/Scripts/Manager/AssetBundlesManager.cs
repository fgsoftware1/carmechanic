...
public class AssetBundlesManager : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        var texturesbundle = AssetBundle.LoadFromFile(Path.Combine(Application.streamingAssetsPath, "objects"));

        handCursor = texturesbundle.LoadAsset<Texture2D>("HandCursor");
